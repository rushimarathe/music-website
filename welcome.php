    ...
    <header>
        ...
        <div class="song_side">
            <nav>
                ...
                <div class="user">
                    <img src="img/rushi.jpg" alt="">
                </div>
            </nav>
            <div class="content">
                <h1>Alen Walker-Fade</h1>
                <p>You were win shadow to my light did you feel us Another strat you fade <br>Away afraid our aim is out
